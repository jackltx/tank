...
public interface State {
    ...
    public void drawMissileSelf(Graphics g, MissileInterface missile);//根据当前方向状态 发射子弹

    public void changeMissilePosition(MissileInterface missile);//根据当前方向 更新子弹最新的xy坐标
}
